...
To complete this practical you need to go through Parts 2-4 of this document and answer the questions. You are strongly encouraged to complete Part 5 as well, but do as much as you can as time permits. Please, submit your report to [voichita.marinescu@imbim.uu.se](voichita.marinescu@imbim.uu.se) **no later than May 27, 2022.**
...
![introduction figure: Cataracts and _CRYBA4_](figures/Introduction_Figure-1.png)
...
![_CRYBA4_ Genecards](figures/Introduction_Figure-2.png)
...
![The UCSC browser interface](figures/BI.png)  
...
![UCSC Browser display modes](figures/dp_modes.png)  
...
![Saving as a .png format](figures/save_png.png)  
...
![BED file example](figures/BED_file_example.png)
...
![Upload custom tracks as  BED files](figures/custom.png)
...
![Choosing  a file](figures/choosef.png)
...
![Managing custom tracks](figures/man_ct.png)
...
![Custom tracks in the UCSC genome browser](figures/cust_view.png)
...
![Starting a new job on the VEP browser interface](figures/VEP-new-job-page.png)
...
![VEP Run completed](figures/VEP_job-done.png)
...
![VEP results preview](figures/VEP-show-all-variants.png)

Note the following:

![VEP results in full](figures/VEP-results-1.png)
...
![Downloading the VEP results](figures/VEP-download.png)
...
![Excel Import Wizard for loading the VEP results](figures/VEP-Excel-Text.png)
...
![Filtering of the VEP results](figures/VEP-filtering.png)
